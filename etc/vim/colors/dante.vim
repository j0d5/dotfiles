...
"      hi ErrorMsg term=standout ctermfg=white ctermbg=red guifg=white
"      guibg=red3
...
"      hi IncSearch term=reverse cterm=reverse gui=reverse,bold
"      guifg=darkgoldenrod2
"      hi Search term=reverse ctermfg=black ctermbg=yellow guifg=gray10
"      guibg=gold2
"      hi Visual term=bold,reverse cterm=bold,reverse ctermfg=gray ctermbg=black
"      gui=bold,reverse guifg=gray40 guibg=black
...
"      hi WildMenu term=standout ctermfg=black ctermbg=yellow guifg=black
"      guibg=gold2
"      hi Folded term=standout ctermfg=blue ctermbg=white guifg=royalblue1
"      guibg=white
"      hi FoldColumn term=standout ctermfg=blue ctermbg=white guifg=royalblue3
"      guibg=white
...
"      gui=bold guifg=lightblue guibg=cyan4
...
"       hi Todo term=standout ctermfg=black ctermbg=yellow gui=bold guifg=gray10
"       guibg=yellow4
