...
let ColourAssignment['Comment'] = {"GUIFG": '#00F2FF',     "CTERMFG": 'Green',     "TERM":   'Bold'}
...
let ColourAssignment['Constant']        = {"GUIFG": '#AE81FF',     "CTERMFG": 'Yellow',    "TERM":  'Underline'}
let ColourAssignment['String']          = {"GUIFG": '#E600F4'}
let ColourAssignment['Character']       = {"GUIFG": '#E600F4'}
...
let ColourAssignment['Conditional']     = {"GUIFG": '#F0FF2A'} " if, then, else, endif, switch, etc.
