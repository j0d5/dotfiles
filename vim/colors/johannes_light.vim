...
"" File: johannes_light.vim                  ""
"" Note: personal theme, light version       ""
""                                           ""
"""""""""""""""""""""""""""""""""""""""""""""""
...
let colors_name="johannes"


"hi Example        guifg=NONE    guibg=NONE    gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE

" normal text
hi Normal          guifg=#303030 guibg=#B0B0B0 gui=NONE ctermfg=gray ctermbg=NONE cterm=NONE 
" like ~ @
hi NonText         guifg=#BCBCBC guibg=#232526 gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
" Character under cursor
hi Cursor          guifg=#20F0F0 guibg=#00FFF0 gui=NONE ctermfg=black ctermbg=white cterm=reverse
" the screen line that the cursor is in when 'cursorline' is set
hi CursorLine      guifg=NONE    guibg=#203080 gui=NONE ctermfg=NONE ctermbg=darkgray cterm=NONE
...
hi LineNr          guifg=#BCBCBC guibg=#232526 gui=NONE ctermfg=gray ctermbg=NONE cterm=NONE
...
hi link IncSearch  Search     " guifg=#FFC7E1 guibg=#0097F1 gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
...
" Syntax
hi Comment         guifg=#0552A4 guibg=NONE    gui=italic ctermfg=cyan ctermbg=NONE cterm=NONE
hi Constant        guifg=#AE81FF guibg=NONE    gui=bold ctermfg=cyan ctermbg=NONE cterm=bold
hi Conditional     guifg=#00F92A guibg=NONE    gui=bold ctermfg=green ctermbg=NONE cterm=bold
hi Delimiter       guifg=#8F8F8F guibg=NONE    gui=NONE ctermfg=cyan ctermbg=NONE cterm=NONE
hi Function        guifg=#B462F0 guibg=NONE    gui=NONE ctermfg=magenta ctermbg=NONE cterm=NONE
hi String          guifg=#E6DBA4 guibg=NONE    gui=NONE ctermfg=yellow ctermbg=NONE cterm=NONE
hi Number          guifg=#FFA0A0 guibg=NONE    gui=NONE ctermfg=lightmagenta ctermbg=NONE cterm=NONE
hi Keyword         guifg=#F926F2 guibg=NONE    gui=bold ctermfg=green ctermbg=NONE cterm=bold
...
hi Identifier      guifg=#AF971F guibg=NONE    gui=bold ctermfg=brown ctermbg=NONE cterm=NONE
hi Type            guifg=#6099FF guibg=NONE    gui=bold ctermfg=blue ctermbg=NONE cterm=bold
hi Statement       guifg=#303000 guibg=NONE    gui=bold ctermfg=green ctermbg=NONE cterm=bold
hi Special         guifg=#66D9EF guibg=bg      gui=italic ctermfg=white ctermbg=NONE cterm=NONE
