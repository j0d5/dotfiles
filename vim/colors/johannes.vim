...
hi CursorLine      guifg=NONE    guibg=#293759 gui=NONE ctermfg=NONE ctermbg=darkgray cterm=NONE
...
" Syntax
hi Comment         guifg=#057274 guibg=NONE    gui=italic ctermfg=cyan ctermbg=NONE cterm=NONE
...
hi String          guifg=#E6DB74 guibg=NONE    gui=NONE ctermfg=yellow ctermbg=NONE cterm=NONE
hi Number          guifg=#FFA0A0 guibg=NONE    gui=NONE ctermfg=lightmagenta ctermbg=NONE cterm=NONE
hi Keyword         guifg=#F92672 guibg=NONE    gui=bold ctermfg=green ctermbg=NONE cterm=bold
...
hi Identifier      guifg=#FF971F guibg=NONE    gui=bold ctermfg=brown ctermbg=NONE cterm=NONE
hi Type            guifg=#6099FF guibg=NONE    gui=bold ctermfg=blue ctermbg=NONE cterm=bold
hi Statement       guifg=#10A032 guibg=NONE    gui=bold ctermfg=green ctermbg=NONE cterm=bold
