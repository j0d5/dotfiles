# ant aliases
alias antbd='ant clean debug -Dsdk.dir=/opt/android/android-sdk-linux -Dndk.dir=/opt/android/android-ndk-r9'
alias antbr='ant clean release -Dsdk.dir=/opt/android/android-sdk-linux -Dndk.dir=/opt/android/android-ndk-r9'
