...
# some path variables
export PATH=$PATH:/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:~/.bin
export PATH=$PATH:/opt/local/bin:/opt/local/sbin:/Users/johannes/QtSDK/Desktop/Qt/474/gcc/bin
